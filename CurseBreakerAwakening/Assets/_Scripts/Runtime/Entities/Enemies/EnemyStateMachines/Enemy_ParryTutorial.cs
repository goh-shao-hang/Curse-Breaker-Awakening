...
{
    public class Enemy_ParryTutorial : EnemyStateMachine
    {
        ...
        private void Awake()
        {
            ...
            this.AddAnyTransition(_deathState, new[] { _healthDepletedCondition, _parriedCondition }); //Higher priority than stun
